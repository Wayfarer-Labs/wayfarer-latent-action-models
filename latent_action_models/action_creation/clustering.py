...
def umap_visualization(
    ...
    *,
    ...
    legend: dict[tuple[int, int, int], str] | None = None, # MODIFIED: Add legend argument
    ...
    if colors and legend:
        # --- MODIFIED: Plot each category from the legend separately ---
